...
*/
  ...
  //% blockId=Upload_HttpGet block="call URL: address %addr|path %path|param1 %f1|value1 %v1|param2 %f2|value2 %v2|param3 %f3|value3 %v3|param4 %f4|value4 %v4"
  //% weight=10
  export function WLJHS_HttpGet(addr: string, path: string, f1: string, v1: string, f2: string, v2: string, f3: string, v3: string, f4: string, v4: string): void {
